...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Storage_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Storage_t qt_meta_stringdata_Storage = {
    {
QT_MOC_LITERAL(0, 7), // "Storage"
QT_MOC_LITERAL(8, 12), // "onFileReaded"
QT_MOC_LITERAL(21, 0) // ""

    },
    "Storage\0onFileReaded\0"
};
...
void Storage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Storage::onFileReaded)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Storage::staticMetaObject = { {
    ...
    qt_meta_stringdata_Storage.offsetsAndSize,
    qt_meta_data_Storage,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Storage_t
, QtPrivate::TypeAndForceComplete<Storage, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
